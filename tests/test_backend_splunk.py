...
Processes.process="test" by Processes.process Processes.dest Processes.process_current_directory Processes.process_hash Processes.process_path Processes.process_integrity_level Processes.original_file_name Processes.parent_process
...
search = | tstats summariesonly=true fillnull_value="null" count min(_time) as firstTime max(_time) as lastTime from datamodel=Endpoint.Processes where Processes.process="test" by Processes.process Processes.dest Processes.process_current_directory Processes.process_hash Processes.process_path Processes.process_integrity_level Processes.original_file_name Processes.parent_process Processes.parent_process_path Processes.parent_process_guid Processes.parent_process_id Processes.process_guid Processes.process_id Processes.user | `drop_dm_object_name(Processes)` | convert timeformat="%F %X" ctime(firstTime) ctime(lastTime) """]