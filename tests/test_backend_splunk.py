...
def test_splunk_data_model_dns():
    splunk_backend = SplunkBackend(processing_pipeline=splunk_cim_data_model())
    rule = """
title: Test
status: test
...
DNS.dest="2001:db8::1" DNS.dest_port=53 DNS.transaction_id=1 DNS.query="example.com" DNS.record_type="AAAA" DNS.src="2001:db8::2" DNS.src_port=53
by DNS.dest DNS.dest_port DNS.answer DNS.ttl DNS.record_type DNS.transaction_id DNS.query DNS.record_type DNS.reply_code_id DNS.src DNS.src_port
